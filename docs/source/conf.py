...
texinfo_documents = [
    (master_doc, 'package_name', 'package_name Documentation',
     author, 'package_name', 'A short description of your python package.',
     'Miscellaneous'),
]
...
html_theme_options = {
    ...
    'nav_title': 'package_name',

    # Specify a base_url used to generate sitemap.xml. If not
    # specified, then no sitemap will be built.
    'base_url': 'https://YourGitHubHandle.github.io/package_name',
    ...
    'repo_url': 'https://github.com/YourGitHubHandle/package_name',
